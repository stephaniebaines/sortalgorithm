...
from getpixeldata import getsomething
...
if __name__ == "__main__":
    ...
    ## A list of pixel related information
    pixels = [] 
    ...
    for f in frames:
        ...
        for i, kl in enumerate(f.getKlusterFinder().getListOfKlusters()):
            ...
            pixels.append(getsomething(klusterid, kl, klpath))
    ...
    #write the pixel information to a JSON file
	with open(outputpath + "/pixels.json", "w") as jf:
		json.dump(pixels, jf)